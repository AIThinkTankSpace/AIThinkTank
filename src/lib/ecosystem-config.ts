...
export const ecosystem: Record<string, EcosystemProject> = {
  tpg: {
    ...
    shortName: "TPG",
    url: "https://www.thepractiseground.space",
    icon: "📚",
    tagline: "Free printable worksheets & posters for kids",
    description: "Grammar, math & science resources — printable posters, worksheets, and practice materials for classrooms and homeschool.",
    ctaLabel: "Visit TPG →",
    stripBg: "bg-gray-900",
...
export const CURRENT_SITE = "aitt";
